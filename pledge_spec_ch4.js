...
describe('For a given promiseA (pA)', function(){
  ...
  describe('that returns promiseB (pB) via .then:', function(){
    ...
    it("if pA's success handler returns promiseZ, pB mimics pZ", function(){
      ...
      // console.log('promiseA',promiseA.then);
      // console.log('promiseB',promiseB.state, promiseB.value);
      console.log('**RESOLVE DEFERRAL A**')
      deferralA.resolve();
      console.log('**RESOLVE DEFERRAL Z**')
      deferralZ.resolve( 'testing' );
      console.log('**CHECK PROMISE A**');
      console.log('promise A:',promiseA);
      console.log('**CHECK PROMISE B**');
